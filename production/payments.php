...
define('NITRO_API_TOKEN', 'CHq4HPJk5YiYs6GXoUZxmal85rnTi6WiGPFH2FjOKZYg4s58Eb2331yWDNvz');
define('NITRO_OFFER_HASH', 'h2ucb7apmt'); 
...
try {
    ...
    if (isset($data['email']) && !empty($data['email'])) {
        ...
        if ($email === false) {
            $email = 'cliente_' . uniqid() . '@ordquestvip.vercel.app';
        }
    } else {
        $email = 'cliente_' . uniqid() . '@ordquestvip.vercel.app';
    }
